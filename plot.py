...
folder        = "sian_weekly_outputs"
output_folder = "sian_weekly_plots"
...
final_csv_path = os.path.join(output_folder, "sian_top6.csv")
final_df.to_csv(final_csv_path, index=False)

print(f"Saved combined CSV: {final_csv_path}")
print("Done. All Sian weekly plots + sian_top6.csv created.")